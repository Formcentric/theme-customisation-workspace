...
Während der Entwicklung können Sie die Werte in der Datei `_variables.json` ändern – Änderungen werden sofort sichtbar.
...
Wenn Sie ein Extended Theme verwenden, können Sie einzelne Templates überschreiben, während der Rest vom Base-Theme geerbt wird. So funktioniert’s:

1. Erstellen Sie die gewünschte Template-Datei in der passenden Verzeichnisstruktur deines Themes
